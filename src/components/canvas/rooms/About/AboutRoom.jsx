...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'NATNAEL', subtitle: '< frontend developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'PROJECTS', subtitle: 'E-Commerce • Voting System • Portfolio' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Computer Science @ Addis Ababa University' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'HTML • CSS • JavaScript • React' },
];
