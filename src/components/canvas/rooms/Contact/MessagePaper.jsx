...
// Comma-separated hostnames allowed to submit, e.g. VITE_ALLOWED_ORIGINS=localhost,natnael.dev
const ALLOWED_ORIGINS = (import.meta.env.VITE_ALLOWED_ORIGINS || 'localhost').split(',').map(s => s.trim()).filter(Boolean);
