...
const AWARDS_DATA = {
    featured: {
        ...
        title: 'Projects',
        items: [
            { label: 'E-Commerce App', date: '', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Nat-bit-ai' },
            { label: 'National Voting System', date: '', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Nat-bit-ai' },
            { label: 'Portfolio Website', date: '', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Nat-bit-ai' },
        ],
    ...
    sotd: {
        ...
        title: 'Certificates',
        items: [],
        platformConfig: { label: 'CERT', color: '#1a1a1a', icon: '🎓' }
    },
    sotm: {
        id: 'award-sotm',
        layout: 'certificate_grid',
