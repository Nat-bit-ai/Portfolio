...
const ROOM_META = {
    null: {
        path: '/',
        title: 'Natnael Zerihun — Frontend Developer',
        description: 'Interactive 3D portfolio of Natnael Zerihun, a frontend developer and Computer Science student in Addis Ababa. Projects built with HTML, CSS, JavaScript and React.',
    },
    about: {
        path: '/about',
        title: 'About Me — Natnael Zerihun',
        description: 'Natnael Zerihun is a 3rd-year Computer Science student at Addis Ababa University who builds clean, responsive interfaces and is applying for internships.',
    },
    gallery: {
        path: '/gallery',
        title: 'Projects — Natnael Zerihun',
        description: 'Browse the projects of Natnael Zerihun: an E-Commerce App, a National Voting System and this portfolio website.',
    },
    studio: {
        path: '/studio',
        title: 'Skills and Links — Natnael Zerihun',
        description: 'HTML, CSS, JavaScript, React, Tailwind CSS, Python, PHP, MySQL, C++, Java, Git and GitHub.',
    },
    contact: {
        path: '/contact',
        title: 'Contact — Natnael Zerihun',
        description: 'Get in touch with Natnael Zerihun for internships, freelance work and collaborations.',
    },
};
