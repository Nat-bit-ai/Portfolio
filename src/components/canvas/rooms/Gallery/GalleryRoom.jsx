...
const FALLBACK_PROJECTS = [
    {
        id: 'ecommerce',
        title: 'E-COMMERCE',
        front: '/textures/gallery/project-ecommerce.webp',
        painted: '/textures/gallery/project-ecommerce_painted.webp',
        url: 'https://github.com/Nat-bit-ai',
    ...
    },
    {
        id: 'voting',
        title: 'VOTING SYSTEM',
        front: '/textures/gallery/project-voting.webp',
        painted: '/textures/gallery/project-voting_painted.webp',
        url: 'https://github.com/Nat-bit-ai',
        description: 'National Voting System: a secure digital voting platform built for nationwide elections and easy voter access.',
        techStack: ['/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/jslogo.webp']
    },
    {
        id: 'portfolio',
        title: 'PORTFOLIO',
        front: '/textures/gallery/project-portfolio.webp',
        painted: '/textures/gallery/project-portfolio_painted.webp',
        url: 'https://github.com/Nat-bit-ai',
